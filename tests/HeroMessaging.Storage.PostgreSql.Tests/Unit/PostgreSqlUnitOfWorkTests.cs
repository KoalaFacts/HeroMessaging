...
public sealed class PostgreSqlUnitOfWorkTests : IAsyncDisposable
{
    ...
    public void Constructor_WithTimeProvider_UsesProvidedTimeProvider()
    {
        ...
        // Act
        var uow = new PostgreSqlUnitOfWork(ValidConnectionString, timeProvider);
        _disposables.Add(uow);
    ...
    [Fact]
    public void Constructor_WithNullTimeProvider_UsesDefaultTimeProvider()
    {
        // Act
        var uow = new PostgreSqlUnitOfWork(ValidConnectionString, null);
        _disposables.Add(uow);
    ...
    [Fact]
    public void Factory_Constructor_WithValidConnectionString_Succeeds()
    {
        // Act
        var factory = new PostgreSqlUnitOfWorkFactory(ValidConnectionString);
    ...
    {
        // Act & Assert
        var exception = Assert.Throws<ArgumentNullException>(() => new PostgreSqlUnitOfWorkFactory(null!));
