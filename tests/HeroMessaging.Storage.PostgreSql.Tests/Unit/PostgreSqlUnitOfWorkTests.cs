...
public class PostgreSqlUnitOfWorkTests
{
    ...
    {
        // Arrange & Act
        var uow = new PostgreSqlUnitOfWork(_connectionString);
    ...
    {
        // Arrange & Act
        var uow = new PostgreSqlUnitOfWork(_connectionString, _timeProvider);
...
public class PostgreSqlUnitOfWorkFactoryTests
{
    private readonly string _connectionString;

    public PostgreSqlUnitOfWorkFactoryTests()
    {
        _connectionString = "Host=localhost;Database=test;Username=test;Password=test";
    }
    ...
    public void Constructor_WithNullConnectionString_ThrowsArgumentNullException()
    {
        ...
        var ex = Assert.Throws<ArgumentNullException>(() =>
            new PostgreSqlUnitOfWorkFactory(null!));
    ...
    {
        // Arrange & Act
        var factory = new PostgreSqlUnitOfWorkFactory(_connectionString);
