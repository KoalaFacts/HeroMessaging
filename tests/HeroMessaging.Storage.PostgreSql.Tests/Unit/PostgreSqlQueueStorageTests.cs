...
public sealed class PostgreSqlQueueStorageTests : IDisposable
{
    ...
    public async Task EnqueueAsync_WithNullOptions_ReturnsQueueEntry()
    {
        ...
        // Act
        var result = await storage.EnqueueAsync(_queueName, message, null, TestContext.Current.CancellationToken);
    ...
    public async Task PeekAsync_WithCustomCount_ReturnsMessages()
    {
        ...
        // Act
        var result = await storage.PeekAsync(_queueName, count, TestContext.Current.CancellationToken);
    ...
    public async Task GetQueueDepthAsync_WithEmptyQueue_ReturnsZero()
    {
        ...
        // Act
        var result = await storage.GetQueueDepthAsync("empty-queue", TestContext.Current.CancellationToken);
    ...
    public async Task CreateQueueAsync_WithNullOptions_ReturnsTrue()
    {
        ...
        // Act
        var result = await storage.CreateQueueAsync("new-queue", null, TestContext.Current.CancellationToken);
    ...
    public async Task QueueExistsAsync_WithExistingQueue_ReturnsTrue()
    {
        ...
        // Act
        await storage.EnqueueAsync(_queueName, CreateTestMessage(), null, TestContext.Current.CancellationToken);
        var result = await storage.QueueExistsAsync(_queueName, TestContext.Current.CancellationToken);
    ...
    public async Task EnqueueAsync_WithCancellationToken_RespondsToCancel()
    {
        ...
        await Assert.ThrowsAnyAsync<OperationCanceledException>(async () =>
            await storage.EnqueueAsync(_queueName, message, null, cts.Token));
    }
    ...
    public async Task DequeueAsync_WithCancellationToken_RespondsToCancel()
    {
        ...
        // Act & Assert
        await Assert.ThrowsAnyAsync<OperationCanceledException>(async () =>
            await storage.DequeueAsync(_queueName, cts.Token));
    }
