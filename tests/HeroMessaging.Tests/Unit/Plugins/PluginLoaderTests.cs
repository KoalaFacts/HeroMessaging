    ...
    public sealed class PluginLoaderTests
    {
        ...
        public async Task LoadAsync_WithNullDescriptor_ThrowsArgumentNullException()
        {
            ...
            var ex = await Assert.ThrowsAsync<ArgumentNullException>(() =>
                loader.LoadAsync(null!, _serviceProviderMock.Object, cancellationToken: TestContext.Current.CancellationToken));
        ...
        public async Task LoadAsync_WithNullServiceProvider_ThrowsArgumentNullException()
        {
            ...
            // Act & Assert
            var ex = await Assert.ThrowsAsync<ArgumentNullException>(() =>
                loader.LoadAsync(descriptor, null!, cancellationToken: TestContext.Current.CancellationToken));
        ...
        public async Task LoadAsync_WithInvalidPluginType_ThrowsInvalidOperationException()
        {
            ...
            await Assert.ThrowsAsync<InvalidOperationException>(() =>
                loader.LoadAsync(descriptor, _serviceProviderMock.Object, cancellationToken: TestContext.Current.CancellationToken));
        }
        ...
        public async Task LoadAsync_WithValidPlugin_ReturnsPluginInstance()
        {
            ...
            // Act
            var result = await loader.LoadAsync(descriptor, _serviceProviderMock.Object, cancellationToken: TestContext.Current.CancellationToken);
        ...
        public async Task CanLoadAsync_WithNullDescriptor_ReturnsFalse()
        {
            ...
            // Act
            var result = await loader.CanLoadAsync(null!, cancellationToken: TestContext.Current.CancellationToken);
        ...
        public async Task CanLoadAsync_WithAbstractType_ReturnsFalse()
        {
            ...
            // Act
            var result = await loader.CanLoadAsync(descriptor, cancellationToken: TestContext.Current.CancellationToken);
        ...
        public async Task ValidateAsync_WithNullDescriptor_ReturnsInvalidResult()
        {
            ...
            // Act
            var result = await loader.ValidateAsync(null!, cancellationToken: TestContext.Current.CancellationToken);
        ...
        public async Task ValidateAsync_WithNullPluginType_ReturnsInvalidResult()
        {
            ...
            // Act
            var result = await loader.ValidateAsync(descriptor, cancellationToken: TestContext.Current.CancellationToken);
