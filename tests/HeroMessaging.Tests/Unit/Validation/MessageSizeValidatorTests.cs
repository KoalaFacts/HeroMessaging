...
public sealed class MessageSizeValidatorTests
{
    ...
    public async Task ValidateAsync_WithMessageUnderLimit_ReturnsSuccess()
    {
        ...
        _jsonSerializerMock
            .Setup(s => s.GetJsonByteCount(message, null))
            .Returns(500);
    ...
    public async Task ValidateAsync_WithNullMessage_CallsSerializer()
    {
        ...
        // Assert
        _jsonSerializerMock.Verify(s => s.GetJsonByteCount(message, null), Times.Once);
    }
    ...
    public async Task ValidateAsync_CalledMultipleTimes_CallsSerializerEachTime()
    {
        ...
        _jsonSerializerMock
            .Setup(s => s.GetJsonByteCount(It.IsAny<IMessage>(), null))
            .Returns(500);
        ...
        // Assert
        _jsonSerializerMock.Verify(s => s.GetJsonByteCount(It.IsAny<IMessage>(), null), Times.Exactly(2));
    }
    ...
    public async Task ValidateAsync_WithDifferentMessages_ReturnsCorrectResultsIndependently()
    {
        ...
        _jsonSerializerMock
            .Setup(s => s.GetJsonByteCount(smallMessage, null))
            .Returns(100);

        _jsonSerializerMock
            .Setup(s => s.GetJsonByteCount(largeMessage, null))
            .Returns(2000);
