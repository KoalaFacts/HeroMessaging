...
public sealed class TransactionCommandProcessorDecoratorTests
{
    ...
    public async Task Send_WithVoidCommand_ExecutesInTransaction()
    {
        ...
        // Act
        await decorator.SendAsync(command, cancellationToken: TestContext.Current.CancellationToken);
    ...
    public async Task Send_WithCommandResponse_ExecutesInTransaction()
    {
        ...
        // Act
        var result = await decorator.SendAsync(command, cancellationToken: TestContext.Current.CancellationToken);
    ...
    public async Task Send_WithException_RethrowsException()
    {
        ...
        var exception = await Assert.ThrowsAsync<InvalidOperationException>(
            async () => await decorator.SendAsync(command, cancellationToken: TestContext.Current.CancellationToken));
...
public sealed class TransactionQueryProcessorDecoratorTests
{
    ...
    public async Task Send_WithQuery_ExecutesInTransaction()
    {
        ...
        // Act
        var result = await decorator.SendAsync(query, cancellationToken: TestContext.Current.CancellationToken);
    ...
    public async Task Send_WithQuery_UsesReadCommittedIsolationLevel()
    {
        ...
        // Act
        await decorator.SendAsync(query, cancellationToken: TestContext.Current.CancellationToken);
    ...
    public async Task Send_WithException_RethrowsException()
    {
        ...
        // Act & Assert
        var exception = await Assert.ThrowsAsync<InvalidOperationException>(
            async () => await decorator.SendAsync(query, cancellationToken: TestContext.Current.CancellationToken));
