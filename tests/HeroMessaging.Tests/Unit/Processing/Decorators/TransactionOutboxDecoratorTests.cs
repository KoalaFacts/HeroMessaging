...
public class TransactionOutboxProcessorDecoratorTests
{
    ...
    public async Task PublishToOutbox_WhenTransactionFails_PropagatesException()
    {
        ...
        var exception = await Assert.ThrowsAsync<InvalidOperationException>(
            async () => await _sut.PublishToOutboxAsync(message, cancellationToken: TestContext.Current.CancellationToken));
    ...
    public async Task PublishToOutbox_WithNullOptions_WorksCorrectly()
    {
        ...
        // Act
        await _sut.PublishToOutboxAsync(message, null, cancellationToken: TestContext.Current.CancellationToken);
    ...
    public async Task StartAsync_CallsInnerStartAsync()
    {
        ...
        // Act
        await _sut.StartAsync(cancellationToken: TestContext.Current.CancellationToken);
...
public class TransactionInboxProcessorDecoratorTests
{
    ...
    public async Task ProcessIncoming_WrapsInTransaction()
    {
        ...
        // Act
        var result = await _sut.ProcessIncomingAsync(message, options, cancellationToken: TestContext.Current.CancellationToken);
    ...
    public async Task ProcessIncoming_WhenInnerReturnsFalse_ReturnsFalse()
    {
        ...
        // Act
        var result = await _sut.ProcessIncomingAsync(message, cancellationToken: TestContext.Current.CancellationToken);
    ...
    public async Task ProcessIncoming_WhenTransactionFails_PropagatesException()
    {
        ...
        // Act & Assert
        var exception = await Assert.ThrowsAsync<InvalidOperationException>(
            async () => await _sut.ProcessIncomingAsync(message, cancellationToken: TestContext.Current.CancellationToken));
    ...
    public async Task GetUnprocessedCount_ReturnsInnerCount()
    {
        ...
        // Act
        var result = await _sut.GetUnprocessedCountAsync(cancellationToken: TestContext.Current.CancellationToken);
