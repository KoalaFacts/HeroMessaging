...
public sealed class InboxProcessorTests : IDisposable
{
    ...
    public async Task ProcessIncoming_WithValidMessage_AddsToInboxAndProcesses()
    {
        ...
        // Act
        var result = await processor.ProcessIncomingAsync(message, cancellationToken: TestContext.Current.CancellationToken);
    ...
    public async Task ProcessIncoming_WithIdempotencyCheck_ChecksForDuplicates()
    {
        ...
        // Act
        var result = await processor.ProcessIncomingAsync(message, options, cancellationToken: TestContext.Current.CancellationToken);
    ...
    public async Task GetUnprocessedCount_ReturnsCountFromStorage()
    {
        ...
        // Act
        var count = await processor.GetUnprocessedCountAsync(cancellationToken: TestContext.Current.CancellationToken);
    ...
    public async Task ProcessWorkItem_WithCommand_ProcessesCommand()
    {
        ...
        // Act
        var result = await processor.ProcessIncomingAsync(command, cancellationToken: TestContext.Current.CancellationToken);
    ...
    public async Task ProcessWorkItem_WithEvent_ProcessesEvent()
    {
        ...
        // Act
        var result = await processor.ProcessIncomingAsync(@event, cancellationToken: TestContext.Current.CancellationToken);
    ...
    public async Task ProcessIncoming_WithDuplicate_LogsWarning()
    {
        ...
        // Act
        await processor.ProcessIncomingAsync(message, options, cancellationToken: TestContext.Current.CancellationToken);
    ...
    public async Task ProcessIncoming_WhenStorageReturnsNull_LogsWarning()
    {
        ...
        // Act
        await processor.ProcessIncomingAsync(message, cancellationToken: TestContext.Current.CancellationToken);
