...
public class QueueProcessorTests
{
    ...
    public async Task Enqueue_WithNullOptions_EnqueuesWithNullOptions()
    {
        ...
        // Act
        await _sut.EnqueueAsync(message, queueName, null, TestContext.Current.CancellationToken);
    ...
    public async Task StartQueue_MultipleTimes_StartsWorkerOnlyOnce()
    {
        ...
        // Act
        await _sut.StartQueueAsync(queueName, TestContext.Current.CancellationToken);
        await _sut.StartQueueAsync(queueName, TestContext.Current.CancellationToken); // Second call should not create new worker
    ...
    public async Task StopQueue_MultipleTimes_CompletesWithoutError()
    {
        ...
        // Act
        await _sut.StopQueueAsync(queueName, TestContext.Current.CancellationToken);
        await _sut.StopQueueAsync(queueName, TestContext.Current.CancellationToken); // Second call should complete without error
    ...
    public async Task GetQueueDepthAsync_ReturnsDepthFromStorage()
    {
        ...
        // Act
        var result = await _sut.GetQueueDepthAsync(queueName, TestContext.Current.CancellationToken);
    ...
    {
        // Act
        var result = await _sut.GetActiveQueuesAsync(TestContext.Current.CancellationToken);
    ...
    public async Task GetActiveQueuesAsync_WithActiveQueues_ReturnsQueueNames()
    {
        ...
        await _sut.StartQueueAsync(queue1, TestContext.Current.CancellationToken);
        await _sut.StartQueueAsync(queue2, TestContext.Current.CancellationToken);
    ...
    public async Task GetActiveQueuesAsync_AfterStoppingQueue_ReturnsRemainingQueues()
    {
        ...
        await _sut.StartQueueAsync(queue1, TestContext.Current.CancellationToken);
        await _sut.StartQueueAsync(queue2, TestContext.Current.CancellationToken);
        await _sut.StopQueueAsync(queue1, TestContext.Current.CancellationToken);
    ...
    public async Task QueueProcessor_EnqueueAndStart_ProcessesMessages()
    {
        ...
        // Act
        await _sut.EnqueueAsync(message.Object, queueName, TestContext.Current.CancellationToken);
        await _sut.StartQueueAsync(queueName, TestContext.Current.CancellationToken);
