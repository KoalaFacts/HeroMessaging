...
public sealed class IdempotencyDecoratorTests
{
    ...
    public async Task ProcessAsync_DifferentMessages_ProcessesBothIndependently()
    {
        ...
        // Act
        await decorator.ProcessAsync(message1, context, cancellationToken: TestContext.Current.CancellationToken);
        await decorator.ProcessAsync(message2, context, cancellationToken: TestContext.Current.CancellationToken);
