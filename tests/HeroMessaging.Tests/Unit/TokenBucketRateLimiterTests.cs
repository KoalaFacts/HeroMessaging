...
public class TokenBucketRateLimiterTests
{
    ...
    public async Task AcquireAsync_WithAvailableTokens_ReturnsSuccess()
    {
        ...
        // Act: Acquire 1 token
        var result = await limiter.AcquireAsync(cancellationToken: TestContext.Current.CancellationToken);
    ...
    public async Task AcquireAsync_WithoutAvailableTokens_RejectsRequest()
    {
        ...
        // Exhaust tokens
        await limiter.AcquireAsync(cancellationToken: TestContext.Current.CancellationToken);
        await limiter.AcquireAsync(cancellationToken: TestContext.Current.CancellationToken);
    ...
    public async Task AcquireAsync_WithBurstCapacity_AllowsBurst()
    {
        ...
        var finalResult = await limiter.AcquireAsync(cancellationToken: TestContext.Current.CancellationToken);
    ...
    public async Task AcquireAsync_WithRejectBehavior_ReturnsImmediately()
    {
        ...
        await limiter.AcquireAsync(cancellationToken: TestContext.Current.CancellationToken); // Exhaust token
    ...
    public async Task AcquireAsync_WithMultiplePermits_ConsumesCorrectly()
    {
        ...
        var result = await limiter.AcquireAsync(permits: 5, cancellationToken: TestContext.Current.CancellationToken);
    ...
    public async Task AcquireAsync_WithInsufficientTokensForPermits_Throttles()
    {
        ...
        var result = await limiter.AcquireAsync(permits: 11, cancellationToken: TestContext.Current.CancellationToken);
    ...
    public async Task AcquireAsync_WithZeroPermits_ThrowsException()
    {
        ...
        await Assert.ThrowsAsync<ArgumentOutOfRangeException>(
            () => limiter.AcquireAsync(permits: 0, cancellationToken: TestContext.Current.CancellationToken).AsTask());
    }
    ...
    public async Task AcquireAsync_WithNegativePermits_ThrowsException()
    {
        ...
        // Act & Assert
        await Assert.ThrowsAsync<ArgumentOutOfRangeException>(
            () => limiter.AcquireAsync(permits: -1, cancellationToken: TestContext.Current.CancellationToken).AsTask());
    }
    ...
    public async Task AcquireAsync_WithDifferentKeys_IndependentBuckets()
    {
        ...
        for (int i = 0; i < 5; i++)
        {
            await limiter.AcquireAsync(key: "key1", cancellationToken: TestContext.Current.CancellationToken);
        }

        // Try to acquire for key2 (should have full bucket)
        var result = await limiter.AcquireAsync(key: "key2", cancellationToken: TestContext.Current.CancellationToken);
    ...
    public async Task AcquireAsync_WithSameKey_SharesBucket()
    {
        ...
        await limiter.AcquireAsync(key: "shared-key", cancellationToken: TestContext.Current.CancellationToken);
        await limiter.AcquireAsync(key: "shared-key", cancellationToken: TestContext.Current.CancellationToken);
        var result = await limiter.AcquireAsync(key: "shared-key", cancellationToken: TestContext.Current.CancellationToken);
    ...
    public async Task AcquireAsync_WithNullKey_UsesGlobalBucket()
    {
        ...
        await limiter.AcquireAsync(key: null, cancellationToken: TestContext.Current.CancellationToken);
        await limiter.AcquireAsync(key: null, cancellationToken: TestContext.Current.CancellationToken);
        var result = await limiter.AcquireAsync(key: null, cancellationToken: TestContext.Current.CancellationToken);
    ...
    public async Task AcquireAsync_WithManyScopedKeys_HandlesCorrectly()
    {
        ...
        for (int i = 0; i < 50; i++)
        {
            var result = await limiter.AcquireAsync(key: $"key-{i}", cancellationToken: TestContext.Current.CancellationToken);
            Assert.True(result.IsAllowed, $"Key {i} should be allowed");
            Assert.Equal(9, result.RemainingPermits);
        }

        // Assert: All keys should have independent buckets
        var finalResult = await limiter.AcquireAsync(key: "key-0", cancellationToken: TestContext.Current.CancellationToken);
        Assert.True(finalResult.IsAllowed);
    ...
    public async Task AcquireAsync_ConcurrentCalls_ThreadSafe()
    {
        ...
        var extraResult = await limiter.AcquireAsync(cancellationToken: TestContext.Current.CancellationToken);
    ...
    public async Task GetStatistics_TracksAcquiredAndThrottled()
    {
        ...
        await limiter.AcquireAsync(cancellationToken: TestContext.Current.CancellationToken); // Success
        await limiter.AcquireAsync(cancellationToken: TestContext.Current.CancellationToken); // Success
        await limiter.AcquireAsync(cancellationToken: TestContext.Current.CancellationToken); // Throttled
        await limiter.AcquireAsync(cancellationToken: TestContext.Current.CancellationToken); // Throttled
    ...
    public async Task AcquireAsync_WithCancellationToken_CancelsCorrectly()
    {
        ...
        await limiter.AcquireAsync(cancellationToken: TestContext.Current.CancellationToken); // Exhaust
    ...
    public async Task Dispose_ReleasesResources()
    {
        ...
        await Assert.ThrowsAsync<ObjectDisposedException>(
            () => limiter.AcquireAsync(cancellationToken: TestContext.Current.CancellationToken).AsTask());
    }
