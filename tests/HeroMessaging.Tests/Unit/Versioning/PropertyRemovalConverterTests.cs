...
public sealed class PropertyRemovalConverterTests
{
    ...
    public async Task ConvertAsync_WithSameVersion_ReturnsSameMessage()
    {
        ...
        // Act
        var result = await converter.ConvertAsync(message, version, version, cancellationToken: TestContext.Current.CancellationToken);
    ...
    public async Task ConvertAsync_WithDifferentVersions_ReturnsOriginalMessage()
    {
        ...
        // Act
        var result = await converter.ConvertAsync(message, fromVersion, toVersion, cancellationToken: TestContext.Current.CancellationToken);
    ...
    public async Task ConvertAsync_WithBackwardCompatibility_HandlesDowngrade()
    {
        ...
        var result = await converter.ConvertAsync(message, maxVersion, minVersion, cancellationToken: TestContext.Current.CancellationToken);
