...
public class HeroMessagingServiceTests
{
    ...
    public async Task SendAsync_WithVoidCommand_CallsCommandProcessorAndIncrementsMetrics()
    {
        ...
        // Act
        await _sut.SendAsync(command, cancellationToken: TestContext.Current.CancellationToken);
    ...
    public async Task SendAsync_WithCommandResponse_CallsCommandProcessorAndReturnsResponse()
    {
        ...
        // Act
        var result = await _sut.SendAsync(command, cancellationToken: TestContext.Current.CancellationToken);
    ...
    public async Task SendAsync_WithQuery_CallsQueryProcessorAndReturnsResponse()
    {
        ...
        // Act
        var result = await _sut.SendAsync(query, cancellationToken: TestContext.Current.CancellationToken);
    ...
    public async Task PublishAsync_WithEvent_CallsEventBusAndIncrementsMetrics()
    {
        ...
        // Act
        await _sut.PublishAsync(@event, cancellationToken: TestContext.Current.CancellationToken);
    ...
    {
        // Act
        var result = await _sut.SendBatchAsync(null!, cancellationToken: TestContext.Current.CancellationToken);
    ...
    public async Task SendBatchAsync_WithEmptyCommands_ReturnsEmptyArray()
    {
        ...
        // Act
        var result = await _sut.SendBatchAsync(commands, cancellationToken: TestContext.Current.CancellationToken);
    ...
    public async Task SendBatchAsync_WithValidCommands_ProcessesAllAndReturnsTrue()
    {
        ...
        // Act
        var results = await _sut.SendBatchAsync(commands, cancellationToken: TestContext.Current.CancellationToken);
    ...
    {
        // Act
        var result = await _sut.SendBatchAsync<string>(null!, cancellationToken: TestContext.Current.CancellationToken);
    ...
    {
        // Act
        var result = await _sut.PublishBatchAsync(null!, cancellationToken: TestContext.Current.CancellationToken);
    ...
    public async Task PublishBatchAsync_WithEmptyEvents_ReturnsEmptyArray()
    {
        ...
        // Act
        var result = await _sut.PublishBatchAsync(events, cancellationToken: TestContext.Current.CancellationToken);
    ...
    public async Task PublishBatchAsync_WithValidEvents_PublishesAllAndReturnsTrue()
    {
        ...
        // Act
        var results = await _sut.PublishBatchAsync(events, cancellationToken: TestContext.Current.CancellationToken);
    ...
    public async Task EnqueueAsync_WithQueueProcessor_CallsQueueProcessorAndIncrementsMetrics()
    {
        ...
        // Act
        await _sut.EnqueueAsync(message, queueName, options, cancellationToken: TestContext.Current.CancellationToken);
    ...
    public async Task EnqueueAsync_WithoutQueueProcessor_ThrowsInvalidOperationException()
    {
        ...
        var exception = await Assert.ThrowsAsync<InvalidOperationException>(
            async () => await service.EnqueueAsync(message, "queue", cancellationToken: TestContext.Current.CancellationToken));
    ...
    public async Task StartQueueAsync_WithQueueProcessor_CallsQueueProcessor()
    {
        ...
        // Act
        await _sut.StartQueueAsync(queueName, cancellationToken: TestContext.Current.CancellationToken);
    ...
    public async Task StartQueueAsync_WithoutQueueProcessor_ThrowsInvalidOperationException()
    {
        ...
        // Act & Assert
        var exception = await Assert.ThrowsAsync<InvalidOperationException>(
            async () => await service.StartQueueAsync("queue", cancellationToken: TestContext.Current.CancellationToken));
    ...
    public async Task StopQueueAsync_WithQueueProcessor_CallsQueueProcessor()
    {
        ...
        // Act
        await _sut.StopQueueAsync(queueName, cancellationToken: TestContext.Current.CancellationToken);
    ...
    public async Task StopQueueAsync_WithoutQueueProcessor_ThrowsInvalidOperationException()
    {
        ...
        // Act & Assert
        var exception = await Assert.ThrowsAsync<InvalidOperationException>(
            async () => await service.StopQueueAsync("queue", cancellationToken: TestContext.Current.CancellationToken));
    ...
    public async Task PublishToOutboxAsync_WithOutboxProcessor_CallsOutboxProcessorAndIncrementsMetrics()
    {
        ...
        // Act
        await _sut.PublishToOutboxAsync(message, options, cancellationToken: TestContext.Current.CancellationToken);
    ...
    public async Task PublishToOutboxAsync_WithoutOutboxProcessor_ThrowsInvalidOperationException()
    {
        ...
        // Act & Assert
        var exception = await Assert.ThrowsAsync<InvalidOperationException>(
            async () => await service.PublishToOutboxAsync(message, cancellationToken: TestContext.Current.CancellationToken));
    ...
    public async Task ProcessIncomingAsync_WithInboxProcessor_CallsInboxProcessorAndIncrementsMetrics()
    {
        ...
        // Act
        await _sut.ProcessIncomingAsync(message, options, cancellationToken: TestContext.Current.CancellationToken);
    ...
    public async Task ProcessIncomingAsync_WithoutInboxProcessor_ThrowsInvalidOperationException()
    {
        ...
        // Act & Assert
        var exception = await Assert.ThrowsAsync<InvalidOperationException>(
            async () => await service.ProcessIncomingAsync(message, cancellationToken: TestContext.Current.CancellationToken));
    ...
    public async Task GetMetrics_AfterMultipleOperations_ReturnsAccumulatedMetrics()
    {
        ...
        // Act
        await _sut.SendAsync(new Mock<ICommand>().Object, cancellationToken: TestContext.Current.CancellationToken);
        await _sut.SendAsync(new Mock<ICommand>().Object, cancellationToken: TestContext.Current.CancellationToken);
        await _sut.SendAsync(new Mock<IQuery<int>>().Object, cancellationToken: TestContext.Current.CancellationToken);
        await _sut.PublishAsync(new Mock<IEvent>().Object, cancellationToken: TestContext.Current.CancellationToken);
