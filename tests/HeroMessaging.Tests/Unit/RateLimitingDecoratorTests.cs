...
public class RateLimitingDecoratorTests
{
    ...
    public async Task ProcessAsync_WithoutAvailableTokens_ThrottlesRequest()
    {
        ...
        var result1 = await decorator.ProcessAsync(message1, context, cancellationToken: TestContext.Current.CancellationToken);
        var result2 = await decorator.ProcessAsync(message2, context, cancellationToken: TestContext.Current.CancellationToken);
    ...
    public async Task ProcessAsync_WhenInnerProcessorFails_StillConsumesToken()
    {
        ...
        var result1 = await decorator.ProcessAsync(message, context, cancellationToken: TestContext.Current.CancellationToken);
        var result2 = await decorator.ProcessAsync(message, context, cancellationToken: TestContext.Current.CancellationToken);
        var result3 = await decorator.ProcessAsync(message, context, cancellationToken: TestContext.Current.CancellationToken);
    ...
    public async Task ProcessAsync_AfterRefill_AllowsMoreRequests()
    {
        ...
        // Verify exhausted
        var resultExhausted = await decorator.ProcessAsync(message, context, cancellationToken: TestContext.Current.CancellationToken);
