...
public class MessagePackMessageSerializerTests
{
    ...
    [Fact]
    public void Constructor_WithBothOptions_UsesProvidedOptions()
    {
        // Arrange
        ...
        // Act
        var serializer = new MessagePackMessageSerializer(options, messagePackOptions);
    ...
    [Fact]
    public async Task SerializeAsync_ProducesSmallerDataThanJson()
    {
        // Arrange
        ...
        // Assert - MessagePack should produce compact binary data
        Assert.NotNull(messagePackData);
        Assert.True(messagePackData.Length > 0);
        // Typical MessagePack efficiency: smaller than JSON
    }
    ...
    public void GetRequiredBufferSize_ReturnsPositiveValue()
    {
        ...
        Assert.Equal(2048, bufferSize); // Default estimate for MessagePack
    }
