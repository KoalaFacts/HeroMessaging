...
public class ProtobufMessageSerializerTests
{
    ...
    public async Task SerializeAsync_WithValidMessage_ReturnsBytes()
    {
        ...
        // Act
        var result = await serializer.SerializeAsync(message, cancellationToken: TestContext.Current.CancellationToken);
    ...
    public async Task SerializeAsync_WithNullMessage_ReturnsEmptyArray()
    {
        ...
        // Act
        var result = await serializer.SerializeAsync<TestMessage>(null!, cancellationToken: TestContext.Current.CancellationToken);
    ...
    public async Task SerializeAsync_WhenMaxSizeExceeded_ThrowsInvalidOperationException()
    {
        ...
        await Assert.ThrowsAsync<InvalidOperationException>(async () =>
            await serializer.SerializeAsync(message, cancellationToken: TestContext.Current.CancellationToken));
    }
    ...
    public async Task DeserializeAsync_WithValidData_ReturnsMessage()
    {
        ...
        var data = await serializer.SerializeAsync(original, cancellationToken: TestContext.Current.CancellationToken);

        // Act
        var result = await serializer.DeserializeAsync<TestMessage>(data, cancellationToken: TestContext.Current.CancellationToken);
    ...
    public async Task DeserializeAsync_WithDynamicType_ReturnsObject()
    {
        ...
        // Act
        var result = await serializer.DeserializeAsync(data, typeof(TestMessage), cancellationToken: TestContext.Current.CancellationToken);
    ...
    public async Task RoundTrip_AsyncSerialization_PreservesData()
    {
        ...
        // Act
        var serialized = await serializer.SerializeAsync(original, cancellationToken: TestContext.Current.CancellationToken);
        var deserialized = await serializer.DeserializeAsync<TestMessage>(serialized, cancellationToken: TestContext.Current.CancellationToken);
    ...
    public async Task RoundTrip_WithComplexObject_PreservesData()
    {
        ...
        // Act
        var serialized = await serializer.SerializeAsync(original, cancellationToken: TestContext.Current.CancellationToken);
        var deserialized = await serializer.DeserializeAsync<ComplexTestMessage>(serialized, cancellationToken: TestContext.Current.CancellationToken);
    ...
    public async Task RoundTrip_WithSpecialCharacters_PreservesData()
    {
        ...
        // Act
        var serialized = await serializer.SerializeAsync(message, cancellationToken: TestContext.Current.CancellationToken);
        var deserialized = await serializer.DeserializeAsync<TestMessage>(serialized, cancellationToken: TestContext.Current.CancellationToken);
    ...
    public async Task RoundTrip_CompressedData_MatchesUncompressed()
    {
        ...
        // Act
        var uncompressedData = await uncompressedSerializer.SerializeAsync(message, cancellationToken: TestContext.Current.CancellationToken);
        var compressedData = await compressedSerializer.SerializeAsync(message, cancellationToken: TestContext.Current.CancellationToken);
        var uncompressedResult = await uncompressedSerializer.DeserializeAsync<TestMessage>(uncompressedData, cancellationToken: TestContext.Current.CancellationToken);
        var compressedResult = await compressedSerializer.DeserializeAsync<TestMessage>(compressedData, cancellationToken: TestContext.Current.CancellationToken);
